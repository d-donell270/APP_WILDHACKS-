...
const BiXDiamondFillicon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-x-diamond-fill navbar-logo-icon" viewBox="0 0 16 16">
        ...
        <div className='navbar-container'>
          <Link to="/" className='navbar-logo' onClick={closeMobileMenu}>
            <div className="logo-container">
              <BiXDiamondFillicon />
              <span className="logo-text">RSRCFUL</span>
            </div>
          </Link>
            ...
            {button && <Button buttonStyle='btn--outline' path='/Services'>SERVICES</Button>}
        </div>
      </nav>
    </>
  );
